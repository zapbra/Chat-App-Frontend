...
export default function SignUp() {
  ...
  return (
    <div className="mx-auto w-fit flex flex-col justify-center items-center">
      ...
      >
        <label>
          <p className="font-bold text-xl text-white mb-2">Full Name</p>
          <input
            {...register("fullName")}
            type="text"
        ...
        <label>
          <p className="font-bold text-xl text-white mb-2">Username *</p>
          <input
            {...register("username", {
        ...
        <label>
          <div className="flex justify-between">
            <p className="font-bold text-xl text-white mb-2">Password *</p>
          ...
          <input
            {...register("password", {
              ...
              validate: {
                ...
                hasSymbol: (v) =>
                  /[^A-Za-z0-9]/.test(v) || "Must include at least one symbol",
              },
            })}
            type="password"
        ...
        <div className="text-right">
          {loading ? (
            ...
            >
              <p className="text-lg font-bold text-sky-900">Sign Up</p>
            </button>
          )}
        </div>
      </form>
      ...
      <p className="text-sky-900 text-lg">
        ...
        <Link to="/sign-in" className="font-bold text-emerald-500 underline">
          Sign In
        </Link>{" "}
      </p>
    </div>
