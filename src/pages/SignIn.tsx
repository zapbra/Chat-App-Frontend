  ...
  return (
    <div className="mx-auto w-fit flex flex-col justify-center items-center">
      ...
      <p className="text-sky-900 text-lg mb-8">
        ...
        <Link to="/sign-up" className="font-bold text-emerald-500 underline">
          Sign Up
        </Link>{" "}
      </p>
      ...
      >
        <label>
          <p className="font-bold text-xl text-white mb-2">Email or Username</p>
          <input
            type="text"
        ...
        <div className="text-right">
          {loading ? (
            ...
            >
              <p className="text-lg font-bold text-sky-900">Sign In</p>
            </button>
          )}
        </div>
      </form>
